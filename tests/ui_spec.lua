...
describe("integration test", function()
    a.tests.it("calls vim APIs as expected during rendering", function()
        ...
        local set_option = spy.on(vim.api, "nvim_buf_set_option")
        ...
        assert.spy(set_option).was_called(9)
        assert.spy(set_option).was_called_with(match.is_number(), "modifiable", false)
        assert.spy(set_option).was_called_with(match.is_number(), "swapfile", false)
        assert.spy(set_option).was_called_with(match.is_number(), "textwidth", 0)
        assert.spy(set_option).was_called_with(match.is_number(), "buftype", "nofile")
        assert.spy(set_option).was_called_with(match.is_number(), "bufhidden", "wipe")
        assert.spy(set_option).was_called_with(match.is_number(), "buflisted", false)
        assert.spy(set_option).was_called_with(match.is_number(), "filetype", "lsp-installer")
