...
local function init(all_servers)
    ...
    local function open()
        ...
        window.open {
            ...
            highlight_groups = {
                LspInstallerHeader = { bold = true, guifg = "#222222", guibg = "#DCA561" },
                LspInstallerHeaderHelp = { bold = true, guifg = "#222222", guibg = "#56B6C2" },
                LspInstallerServerExpanded = { italic = true },
                LspInstallerHeading = { bold = true },
                LspInstallerGreen = { guifg = "#a3be8c" },
                LspInstallerVaderSaber = { bold = true, guifg = "#f44747" },
                LspInstallerOrange = { ctermfg = "222", guifg = "#DCA561" },
                LspInstallerMuted = { ctermfg = "144", guifg = "#888888" },
                LspInstallerLabel = { bold = true },
                LspInstallerError = { ctermfg = "203", guifg = "#f44747" },
                LspInstallerHighlighted = { guifg = "#56B6C2" },
                LspInstallerVersionCheckLoader = { bold = true, guifg = "#222222", guibg = "#888888" },
                LspInstallerVersionCheckLoaderDone = { bold = true, guifg = "#222222", guibg = "#a3be8c" },
                LspInstallerLink = { link = "LspInstallerHighlighted" },
            },
            effects = {
